...
const Favorites = ({
    ...
    if (isLoading) {
        ...
        const MyFavorites=({favorites,deleteFavorite}) =>{
           return favorites.dishes.map((dish) => {
                return <div key={dish._id} className="col-12 mt-5">
        ...
        return(
            <div className="container">
                ...
                <div className="row">
                    <Media list>
                        <MyFavorites favorites={favorites} deleteFavorite={deleteFavorite}/>
                    </Media>
                </div>
            </div>
        );
