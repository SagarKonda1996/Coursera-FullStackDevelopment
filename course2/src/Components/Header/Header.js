        ...
        <div>
                <Navbar dark expand="md">
                    <div className="container">
                        <NavbarToggler onClick={e=>setIsNavOpen(!isNavOpen)} />
                    ...
                    <ModalBody>
                        ...
                        <FormGroup>
                                ...
                                <Input type="text" id="username" name="username"
                                    innerRef={(input) =>inputref.current.username = input} />
                            </FormGroup>
                            <FormGroup>
                                <Label htmlFor="password">Password</Label>
                                <Input type="password" id="password" name="password"
                                    innerRef={(input) =>inputref.current.password = input}  />
                            </FormGroup>
                            <FormGroup check>
                                <Label check>
                                    <Input type="checkbox" name="remember"
                                    innerRef={(input) =>inputref.current.remember = input}  />
                                    Remember me
                                </Label>
                            </FormGroup>
